...
export declare const InteractionType: {
    ...
    readonly MessageComponent: "MESSAGE_COMPONENT";
    readonly ModalSubmit: "MODAL_SUBMIT";
};
...
export declare const GatewayEvents: {
    ...
    readonly ApplicationCommandCreate: "APPLICATION_COMMAND_CREATE";
    readonly ApplicationCommandUpdate: "APPLICATION_COMMAND_UPDATE";
    readonly ApplicationCommandDelete: "APPLICATION_COMMAND_DELETE";
    readonly WebhookDelivery: "WEBHOOK_DELIVERY";
};
